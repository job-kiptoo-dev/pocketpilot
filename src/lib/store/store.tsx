...
import type { AppData, SavingsGoal, Transaction } from "@/lib/types";
import { seedData } from "@/lib/db/fixtures";
import { genId } from "@/lib/db/memory";
import { parseMpesa, type ParsedTransaction } from "@/lib/mpesa/parse";
import { currentBalance } from "@/lib/finance/util";
